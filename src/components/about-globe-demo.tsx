...
// If using Next.js, use dynamic import. For Vite/CRA, import directly:
// import { World } from "../ui/globe";

// Placeholder for World import. Replace with actual import if available.
const World = (props: any) => <div className="bg-neutral-900 rounded-xl flex items-center justify-center h-96 text-cyan-300">[Globe Visualization Placeholder]</div>;
